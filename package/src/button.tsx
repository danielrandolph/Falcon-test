...
const button = tv({
  ...
  variants: {
    variant: {
      primary:
        "tw:bg-blue-600 tw:text-white tw:hover:bg-blue-700 tw:pressed:bg-blue-800",
      secondary:
        "tw:border-black/10 tw:bg-neutral-50 tw:text-neutral-800 tw:hover:bg-neutral-100 tw:pressed:bg-neutral-200",
      destructive:
        "tw:bg-red-700 tw:text-white tw:hover:bg-red-800 tw:pressed:bg-red-900",
      quiet:
        "tw:border-0 tw:bg-transparent tw:text-neutral-800 tw:hover:bg-neutral-200 tw:pressed:bg-neutral-300",
    },
    isDisabled: {
...
export function Button({ variant, ...otherProps }: ButtonProps) {
  return (
    <RACButton
      {...otherProps}
    ...
    >
      {composeRenderProps(otherProps.children, (children, { isPending }) => (
        <>
          {children}
